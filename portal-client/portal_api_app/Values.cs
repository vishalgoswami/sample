...
{
    internal partial class Values : IServiceOperations<PortalApiApp>, IValues
    {
        /// <summary>
        ...
        /// </param>
        internal Values(PortalApiApp client)
        {
            this._client = client;
        }
        
        private PortalApiApp _client;
        
        /// <summary>
        /// Gets a reference to the PortalClient.PortalApiApp.
        /// </summary>
        public PortalApiApp Client
        {
